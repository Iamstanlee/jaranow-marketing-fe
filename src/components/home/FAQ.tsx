...
const FAQ: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'For our 10-minute delivery service, orders start from ₦1,500 plus delivery fee. For our laundry service, you can choose from our subscription plans starting at ₦15,999/month.'
    },
    {
