...
const ProblemSolution: React.FC = () => {
  ...
  const solutions = [
    {
      icon: <Mic className="w-8 h-8 text-[#2563eb]" />,
    ...
    {
      icon: <Camera className="w-8 h-8 text-[#2563eb]" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-8">
            ...
            <span className="text-gray-400"> Grocery Shopping</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {problems.map((problem, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gray-100 border border-gray-200 rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-all duration-300"
              >
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Meet <span className="text-[#2563eb]">Jara AI</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-primary-100 to-blue-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-primary-200 shadow-lg"
              >
                ...
                <div className="bg-white rounded-lg p-4 border-l-4 border-[#2563eb]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-16 bg-gradient-to-r from-[#2563eb] to-primary-700 rounded-2xl p-8 text-white"
          >
